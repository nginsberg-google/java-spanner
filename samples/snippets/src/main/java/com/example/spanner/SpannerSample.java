...
public class SpannerSample {
  ...
  static void run(
      ...
      CodeLab2 codeLab2 = new CodeLab2();
    switch (command) {
      case "createdatabase":
      ...
      case "hubbleWriteMessagesInterleavedParallel":
        ...
        break;
      case "hubbleWriteMessagesInterleavedParallel100k":
        codeLab1.hubbleWriteMessagesInterleavedParallel100k(dbClient, 40, 50, 100000);
        break;
      case "hubbleCreateJoinTables":
        codeLab2.hubbleCreateJoinTables(dbAdminClient, database);
        break;
      case "hubbleInsertTestDataToJoinTables":
        codeLab2.hubbleInsertTestDataToJoinTables(dbClient, 50, 100000);
        break;
      ...
      case "hubbleWriteWorkItems":
        codeLab1.hubbleWriteWorkItems(dbClient, 1000, 50);
        break;
      case "hubbleDoWorkParallelLocking":
        codeLab1.hubbleDoWorkSingleTransactionParallelLocking(dbClient);
        break;
      case "hubbleDoWorkParallelNonLocking":
        codeLab1.hubbleDoWorkSingleTransactionParallelNonLocking(dbClient);
        break;
      case "write":
